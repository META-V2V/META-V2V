...
class ADAgent:
    ...
    @staticmethod
    def get_one(must_start_from_junction: bool=True) -> 'ADAgent':
        """
        Randomly generates an ADS instance representation

        :param bool must_start_from_junction: whether the ADS instance must start from a junction, default to True
...
class ADSection:
    ...
    def add_agent(self, adc: ADAgent) -> bool:
        ...
        :param ADAgent adc: the ADAgent instance representation to be added
    ...
    def has_conflict(self, adc: ADAgent) -> bool:
        ...
        :param ADAgent adc: the ADAgent instance representation to be checked for conflict

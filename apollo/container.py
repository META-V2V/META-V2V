...
class ApolloContainer:
    ...
    def __dreamview_operation(self, op: str) -> None:
        """
    ...
    def start_dreamview(self) -> None:
        """
        Start Dreamview
        """
        self.__dreamview_operation('start')

    def stop_dreamview(self) -> None:
        """
        Stop Dreamview
        """
        self.__dreamview_operation('stop')

    def restart_dreamview(self) -> None:
        """
        Restart Dreamview
        """
    ...
    def reset_bridge_connection(self) -> None:
        """
    ...
    def __modules_operation(self, op: str) -> None:
        """
    ...
    def restart_modules(self) -> None:
        """
        Restart all the necessary modules
        """
        self.__modules_operation('restart')

    def start_recorder(self, record_id: str) -> None:
        """
    ...
    def start_sim_control_standalone(self) -> None:
        """
    ...
    def stop_sim_control_standalone(self) -> None:
        """

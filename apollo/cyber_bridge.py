...
class CyberBridge:
    ...
    def add_subscriber(self, channel: Channel, cb) -> None:
        """
    ...
    def add_publisher(self, channel: Channel) -> None:
        """
    ...
    def receive_publish(self, data: bytes) -> None:
        """
    ...
    def publish(self, channel: Channel, data: bytes) -> None:
        """

...
META²V2V is a **METAmorphic** framework designed to evaluate the decision-making quanlity of Autonomous Driving Systems (ADS) in multi-agent scenarios with vehicle-to-vehicle (V2V)
